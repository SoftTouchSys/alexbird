...
const Projects = () => {
  const handleSlideDivs = () => {
    $(".card__detail__div1").css("bottom", "-100%");
    $(".card__detail__div2").css("bottom", "-100%");
    $(".card__detail__div3").css("bottom", "-100%");
    $(".card__detail__div4").css("bottom", "-100%");
    $(".card__detail__div5").css("bottom", "-100%");
    $(".card__detail__div6").css("bottom", "-100%");
    $(".card__detail__div7").css("bottom", "-100%");
    $(".card__detail__div8").css("bottom", "-100%");
    $(".card__detail__div9").css("bottom", "-100%");
  ...
  return (
    <Fragment>        
      <div className="bg__black__effect" onClick={handleNavbar}></div>
      <div className="bg__black__effect"></div>

      <Container fluid={true} className="p-0 section s1">
        <Row className="m-0 p-0 s1__top__area">
          <Col xxl={12} xl={12} lg={12} md={12} sm={12} xs={12} className='p-0' onClick={handleSlideDivs}></Col>
        </Row>
            ...
            <Col className='p-0 s1__main__div'>
              <Row className="p-0 m-0" onClick={handleSlideDivs}>
                ...
                <div className="circle__nav__btn" onClick={handleNavbar}>
                    {isClicked && (
                      <img src="./images/Nav-btn-desktop.svg" className="navlogo1" alt="ig" />
                    )}
                    ...
                    <ul className="p-0">
                      <div className="li1__container">
                        <Link to="/about" style={{ textDecoration: "none" }}>
                          <li className="li1" id="about">About</li>
                        </Link>

                        <Link to="/" style={{ textDecoration: "none" }}>
                          <li className="li1 activeli" id="projects">Projects</li>
                        </Link>

                        <Link to="/resume" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
                      ...
                      <div className="icon__container">
                        ...
                        <a href="https://www.linkedin.com/in/adabird/" target="_blank" rel="noopener noreferrer">
